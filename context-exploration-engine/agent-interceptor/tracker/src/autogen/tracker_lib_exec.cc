/**
 * Auto-generated execution implementation for dt_tracker ChiMod
...
#include "dt_provenance/dt_tracker/autogen/tracker_methods.h"
...
clio::run::TaskResume Runtime::Run(clio::run::u32 method, clio::run::shared_ptr<clio::run::Task> task_ptr) {
  ...
  switch (method) {
    ...
    case Method::kStoreInteraction: {
      // Cast task handle to specific type (in-place reinterpret)
      auto& typed_task = task_ptr.template Cast<StoreInteractionTask>();
      CLIO_CO_AWAIT(StoreInteraction(typed_task));
      break;
    }
    case Method::kQuerySession: {
      // Cast task handle to specific type (in-place reinterpret)
      auto& typed_task = task_ptr.template Cast<QuerySessionTask>();
      CLIO_CO_AWAIT(QuerySession(typed_task));
      break;
    }
    case Method::kListSessions: {
      // Cast task handle to specific type (in-place reinterpret)
      auto& typed_task = task_ptr.template Cast<ListSessionsTask>();
      CLIO_CO_AWAIT(ListSessions(typed_task));
      break;
    }
    case Method::kGetInteraction: {
      // Cast task handle to specific type (in-place reinterpret)
      auto& typed_task = task_ptr.template Cast<GetInteractionTask>();
      CLIO_CO_AWAIT(GetInteraction(typed_task));
      break;
    }
    default: {
...
clio::run::shared_ptr<clio::run::Task> Runtime::NewCopyTask(clio::run::u32 method, clio::run::shared_ptr<clio::run::Task>& orig_task_ptr, bool deep) {
  ...
  switch (method) {
    ...
    case Method::kStoreInteraction: {
      // Allocate new task
      auto new_task_ptr = ipc_manager->NewTask<StoreInteractionTask>();
      if (!new_task_ptr.IsNull()) {
        // Copy task fields (includes base Task fields)
        auto& task_typed = orig_task_ptr.template Cast<StoreInteractionTask>();
        new_task_ptr->Copy(ctp::ipc::FullPtr<StoreInteractionTask>(task_typed.get()));
        return new_task_ptr.template Cast<clio::run::Task>();
      }
      break;
    }
    case Method::kQuerySession: {
      // Allocate new task
      auto new_task_ptr = ipc_manager->NewTask<QuerySessionTask>();
      if (!new_task_ptr.IsNull()) {
        // Copy task fields (includes base Task fields)
        auto& task_typed = orig_task_ptr.template Cast<QuerySessionTask>();
        new_task_ptr->Copy(ctp::ipc::FullPtr<QuerySessionTask>(task_typed.get()));
        return new_task_ptr.template Cast<clio::run::Task>();
      }
      break;
    }
    case Method::kListSessions: {
      // Allocate new task
      auto new_task_ptr = ipc_manager->NewTask<ListSessionsTask>();
      if (!new_task_ptr.IsNull()) {
        // Copy task fields (includes base Task fields)
        auto& task_typed = orig_task_ptr.template Cast<ListSessionsTask>();
        new_task_ptr->Copy(ctp::ipc::FullPtr<ListSessionsTask>(task_typed.get()));
        return new_task_ptr.template Cast<clio::run::Task>();
      }
      break;
    }
    case Method::kGetInteraction: {
      // Allocate new task
      auto new_task_ptr = ipc_manager->NewTask<GetInteractionTask>();
      if (!new_task_ptr.IsNull()) {
        // Copy task fields (includes base Task fields)
        auto& task_typed = orig_task_ptr.template Cast<GetInteractionTask>();
        new_task_ptr->Copy(ctp::ipc::FullPtr<GetInteractionTask>(task_typed.get()));
        return new_task_ptr.template Cast<clio::run::Task>();
      }
      break;
    }
...
void Runtime::AggregateOut(clio::run::u32 method, clio::run::shared_ptr<clio::run::Task>& orig_task,
  ...
  switch (method) {
    ...
    case Method::kStoreInteraction: {
      auto& typed_task = orig_task.template Cast<StoreInteractionTask>();
      typed_task->AggregateOut(ctp::ipc::FullPtr<clio::run::Task>(replica_task.get()));
      break;
    }
    case Method::kQuerySession: {
      auto& typed_task = orig_task.template Cast<QuerySessionTask>();
      typed_task->AggregateOut(ctp::ipc::FullPtr<clio::run::Task>(replica_task.get()));
      break;
    }
    case Method::kListSessions: {
      auto& typed_task = orig_task.template Cast<ListSessionsTask>();
      typed_task->AggregateOut(ctp::ipc::FullPtr<clio::run::Task>(replica_task.get()));
      break;
    }
    case Method::kGetInteraction: {
      auto& typed_task = orig_task.template Cast<GetInteractionTask>();
      typed_task->AggregateOut(ctp::ipc::FullPtr<clio::run::Task>(replica_task.get()));
      break;
    }
    default: {
...
void Runtime::AggregateIn(clio::run::u32 method, clio::run::shared_ptr<clio::run::Task>& agg_task,
  ...
  switch (method) {
    ...
    case Method::kStoreInteraction: {
      auto& typed_task = agg_task.template Cast<StoreInteractionTask>();
      typed_task->AggregateIn(ctp::ipc::FullPtr<clio::run::Task>(member_task.get()));
      break;
    }
    case Method::kQuerySession: {
      auto& typed_task = agg_task.template Cast<QuerySessionTask>();
      typed_task->AggregateIn(ctp::ipc::FullPtr<clio::run::Task>(member_task.get()));
      break;
    }
    case Method::kListSessions: {
      auto& typed_task = agg_task.template Cast<ListSessionsTask>();
      typed_task->AggregateIn(ctp::ipc::FullPtr<clio::run::Task>(member_task.get()));
      break;
    }
    case Method::kGetInteraction: {
      auto& typed_task = agg_task.template Cast<GetInteractionTask>();
      typed_task->AggregateIn(ctp::ipc::FullPtr<clio::run::Task>(member_task.get()));
      break;
    }
    default: {
