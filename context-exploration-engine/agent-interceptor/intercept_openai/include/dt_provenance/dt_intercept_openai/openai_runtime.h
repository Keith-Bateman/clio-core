#ifndef DT_PROVENANCE_INTERCEPTION_OPENAI_RUNTIME_H_
#define DT_PROVENANCE_INTERCEPTION_OPENAI_RUNTIME_H_
...
/**
 * Runtime container for the OpenAI Interception ChiMod
 *
 * Owns an httplib HTTPS client pointing at api.openai.com.
 * Handles InterceptAndForward: forward → receive → parse → dispatch to tracker.
 */
class Runtime : public clio::run::Container {
 public:
  using CreateParams = dt_provenance::intercept_openai::CreateParams;
...
#endif  // DT_PROVENANCE_INTERCEPTION_OPENAI_RUNTIME_H_
