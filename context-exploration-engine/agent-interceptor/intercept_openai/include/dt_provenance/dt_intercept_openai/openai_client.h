#ifndef DT_PROVENANCE_INTERCEPTION_OPENAI_CLIENT_H_
#define DT_PROVENANCE_INTERCEPTION_OPENAI_CLIENT_H_
...
/**
 * Client API for the OpenAI Interception ChiMod
 */
class Client : public clio::run::ContainerClient {
 public:
  ...
  /** Create the OpenAI interception container */
  ...
  /**
   * Intercept and forward a request to OpenAI
...
#endif  // DT_PROVENANCE_INTERCEPTION_OPENAI_CLIENT_H_
